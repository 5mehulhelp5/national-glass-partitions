...
return [
    'modules' => [
        ...
        'Scommerce_Core' => 0,
        'Scommerce_OptimiserBase' => 0,
        'Scommerce_ImageOptimiser' => 0,
        'Scommerce_InfiniteScrolling' => 0,
        'Scommerce_LazyLoading' => 0,
        'Scommerce_CacheWarmer' => 0,
        'Scommerce_SpeedOptimiser' => 0,
        'Smartwave_Core' => 1,
